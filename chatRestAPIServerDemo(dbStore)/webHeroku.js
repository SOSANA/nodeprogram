/*
 * Rapid Prototyping with JS is a JavaScript and Node.js book that will teach you how to build mobile and 
 * web apps fast. — Read more at http://rapidprototypingwithjs.com.
 * 
 * We should have everything set up for writing the Node.js application which will work both locally and on 
 * Heroku. The source code is available under rpjs/mongo¹¹⁹. The structure of the application is simple:
 * 
*/
